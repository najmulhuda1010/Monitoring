    ...
    <div class="panel panel-default">
      ...
      <?php
          ...
          // dd($periods[0]->datestart);
					  ?>
        <div class="column" style="width:20px; margin-top:10px">
            <b>OR</b>
        </div>
			<div class="column">
			<div class="area" style="width:175px">Period</div>
			  <div class="brone">
               ...
               ?>
                <option value="{{ $row->datestart }}/{{ $row->dateend }}">{{ $row->datestart }} to {{ $row->dateend }}</option>
               <?php   
                }
               ?>
				</select>
      ...
      <button id="btn">Excel Export</button>
          ...
          if(isset($_GET['submit']))
          {
            ...
            if($divisionid!='' and $divisionid!='select' and $region=='')
            {
              // dd("Only Division");
              ...
              $sectionsdata = DB::select(DB::raw("SELECT CONCAT(section,'.', sub_id) AS si,string_agg
                      ...
                      // dd($sectionsdata);
            }elseif($divisionid!='' and $region !='' and $area == '')
            {
              ...
              $sectionsdata = DB::select(DB::raw("SELECT CONCAT(section,'.', sub_id) AS si,string_agg
                      ...
                      // dd($sectionsdata);
            }elseif($divisionid!='' and $region !='' and $area!='' and $quarterly=='')
            {
        ...
        <div style="overflow-x: auto">
          <table style="text-align: center;font-size:13" id="tblReport" style="width: 100%;">
               <thead class="noExl">
                <tr align="center">
                    <td></td>
                    <td></td>
