      ...
      <div class="row">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    <p class="font-size-h4">Area : <?php echo $areaname; ?></p>
                  </div>
            </div>
            </div>
            </form>
              ...
              <table style="text-align: center;font-size:13" style="font-size: 13;" class="table table-bordered">
                ...
                <tbody>
                  ...
                  $month=0;
                   ...
                   $m='';
                   $mn='';
                      // $checkdata= DB::select(DB::raw("select year,quarterly from mnw.monitorevents where area_id='$a_id' group by year,quarterly order by year DESC, quarterly DESC OFFSET 0 LIMIT 3"));
                      $checkdataPrevious= DB::select(DB::raw("select year,quarterly from mnwv2.monitorevents where area_id='$a_id' and areacompletestatus =1 group by year,quarterly  order by year DESC, quarterly DESC LIMIT 2"));
                      $checkdataCurrent= DB::select(DB::raw("select year,quarterly from mnwv2.monitorevents where area_id='$a_id' and areacompletestatus =0 group by year,quarterly  order by year DESC, quarterly DESC LIMIT 1"));
                      // dd($checkdata);
                      ...
                      // dd($areadata[1]);
                            ...
                            // $checkbrnch= DB::select(DB::raw("select * from mnwv2.monitorevents where branchcode='8420' and year='$year' and quarterly = '$quarter' and area_id='$a_id'"));
                         ...
                         //echo $brcode."/";
                          ...
                          if($score !=0 or $score==null)
                          {
                           ...
                           <tr>
                             <td>
                             <a style="color: #3699FF" href="ADashboard?event=<?php echo $year."-".$quarter."-".$a_id; ?>"><?php echo $year."-".$quarter; ?></a></td>
        ...
        <div class="col-md-12">
          ...
          if($evyear !='' and $evquarter !='')
          {
            ...
            $y = date('Y');
            $mon = date('m');
            $checkLast= DB::select(DB::raw("select * from mnwv2.monitorevents where area_id='$a_id' and areacompletestatus =1 order by id DESC LIMIT 1"));
            if(!empty($checkLast))
            {
          ...
          $cycle = $evyear."-".$evquarter;
           ...
           $evyear = $exp[0];
           $quarter = $exp[1];
           $areas = DB::select(DB::raw("select * from mnwv2.monitorevents where area_id='$a_id' and year='$evyear' and quarterly='$quarter'"));
           if(!empty($areas))
           {
             for($i=1; $i <=5; $i++)
             {
                  ...
                  <tbody>
                   ...
                   // $sec = $sect;
                    ...
                    foreach($areadata as $row)
                    {
                      ...
                      ?>
                    <tr>
                      <td width="10%" style="text-align:center;"><button class="btn btn-light" onClick="sectionDiv(<?php echo $event_id; ?>,<?php echo $i; ?>);"><?php echo $brname; ?></button></td>
