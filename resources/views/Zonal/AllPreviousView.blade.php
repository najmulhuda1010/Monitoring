...
@section('title','Zonal Previous Data View')
  ...
  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Zonal Previous Data View</h5>
      </div>
      <!--end::Info-->
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-custom gutter-b">
            <!--begin::Form-->
            <form action="ZonalAllPreviousData" method="GET" target="_blank">
            <div class="card-body">
              <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-2" id="monthFilterLabel1" style="display: none">
                ...
                <div class="col-md-2" id="monthFilterLabel2" style="display: none">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" name="cluster" id="period">
                        <option value="">select</option>
                        <?php 
                           foreach ($allcluster as $row) {
                               ?>
                                  <option value="<?php echo $row->cluster_id; ?>"><?php echo $row->cluster_name; ?>(<?php echo $row->cluster_id; ?>)</option>
                               <?php
                           }
                        ?>
                    </select>
