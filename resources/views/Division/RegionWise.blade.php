...
@section('title','Region Wise Acheivement')
  ...
  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Region Wise Acheivement</h5>
      </div>
      <!--end::Info-->
    </div>
  </div>
        ...
        <div class="col-md-12">
          <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
              <h3 class="card-title">Section <?php echo $section.": ". $name;  ?></h3>
            </div><!-- /.box-header -->
            <!--begin::Form-->
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  $ct =0;
                  $cntt =0;
                  $region = DB::select(DB::raw("select region_id from mnwv2.monitorevents where division_id='$division' and year='$year' and quarterly='$quarter' group by region_id order by region_id ASC"));
                      foreach($region as $row)
                      {
                         $sp =0;
                         $qsp=0;
                         $region_id = $row->region_id;
                         $dataget = DB::select(DB::raw("select * from mnwv2.monitorevents where region_id='$region_id' and year='$year' and quarterly='$quarter'"));
                     ...
                     <table style="text-align: center;font-size:13" id="<?php echo "dv".$ct; ?>" class="table" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        foreach ($area as $row) 
                        {
                          ...
                          $totalspoint=0;
                          $totalsectp =0;
                          $eventid = DB::select(DB::raw("select * from mnwv2.monitorevents where region_id='$region_id' and year='$year' and quarterly='$quarter' and area_id='$areaid'"));
                          if(!empty($eventid))
                          {
                        ...
                        ?>
                        <tr>
                          <td width="10%" style="text-align:center;"><button class="btn btn-light" onClick="sectionBranchDiv(<?php echo $section.",".$areaid.",".$year.",'".$quar."'"; ?>)"><?php echo $areaname; ?></button></td>
