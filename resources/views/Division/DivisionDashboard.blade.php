                        ...
                        if(!empty($checkdataCurrent))
                        {
                          foreach($checkdataCurrent as $row)
                          {
                            ...
                            foreach($divisiondata as $rw)
                            {
                              ...
                              $checkbrnch= DB::select(DB::raw("select * from mnwv2.monitorevents where branchcode='$brcode' and year='$year' and quarterly = '$quarter' and division_id='$a_id' and areacompletestatus =0"));
                              if(!empty($checkbrnch))
                              {
