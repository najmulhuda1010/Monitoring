...
@section('title','Edit Ongoing Event')
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
      <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
          <!--begin::Page Title-->
          <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Update Ongoing Event</h5>
        </div>
        <!--end::Info-->
      </div>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="row">  
              <div class="col-md-8 col-xs-12 col-sm-12 offset-md-2">   
                ...
                @endif
                <form id="UserEditStore" action="UpdateOngoing" method="POST">
