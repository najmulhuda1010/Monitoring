...
@section('title','Ongoing Events Report')
  ...
  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Ongoing Events Report</h5>
      </div>
      <!--end::Info-->
    </div>
  </div>
...
<script>
    ...
    $(function () {
       ...
       columns: [
           ...
           {data: 'm1', name: 'm1',searchable: false},
           {data: 'monitor2_code', name: 'monitor2_code'},
           {data: 'm2', name: 'm2',searchable: false},
