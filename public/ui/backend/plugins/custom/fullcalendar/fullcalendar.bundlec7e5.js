    ...
    var DayHeader = /** @class */ (function (_super) {
        ...
        DayHeader.prototype._renderSkeleton = function (context) {
            ...
            parentEl.appendChild(this.el = htmlToElement('<div class="fc-row ' + theme.getClass('headerRow') + '">' +
                '<table style="text-align: center;font-size:13" class="' + theme.getClass('tableGrid') + '">' +
                '<thead></thead>' +
                '</table>' +
                '</div>'));
    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.renderSegList = function (allSegs) {
            ...
            var daySegs;
            var i;
            var tableEl = core.htmlToElement('<table style="text-align: center;font-size:13" class="fc-list-table ' + theme.getClass('tableList') + '"><tbody></tbody></table>');
